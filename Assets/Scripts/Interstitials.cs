...
public class Interstitials : MonoBehaviour
{
  ...
  private static string[] stuff =
  {
    ...
    "If you are over 65, you may be eligible for the Silver Support Scheme, where the government gives monthly payouts of $300 to $750.",
  ...
  private void Start()
  {
    ...
    tip.text = stuff[Random.Range(0,3)];
  }
